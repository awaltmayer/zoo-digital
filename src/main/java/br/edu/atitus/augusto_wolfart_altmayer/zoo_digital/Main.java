package br.edu.atitus.augusto_wolfart_altmayer.zoo_digital;
...
public class Main {
    ...
    public static void main(String[] args) {
        ...
        do {
            ...
            switch (opcao) {
                ...
                case 7 -> exibirTotal();
                case 0 -> System.out.println("Encerrando o Zoo Digital. Até logo!");
    ...
    private static void cadastrarAnimal() {
        ...
        System.out.println("  Mamíferos : 1-Cachorro  2-Gato  3-Golfinho  4-Baleia  5-Lobo");
        System.out.println("  Aves      : 6-Pato  7-Pinguim  8-Aguia  9-Flamingo");
        System.out.println("  Peixes    : 10-PeixeMorcego  11-Traíra  12-Piranha  13-TubarãoBalleia");
        System.out.println("  Répteis   : 14-CobraCoral  15-Jabuti  16-JacaréAçu  17-Lagartixa");
    ...
    private static int lerInteiro(String prompt) {
        while (true) {
            ...
            try {
                ...
                System.out.println("⚠️  Entrada inválida. Por favor, informe um número inteiro.");
            }
        }
    }
}